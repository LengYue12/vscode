            ...
            <div class="content-container">
              ...
              <div v-for="section in course.courseSections.slice(0,1)">                
                ...
                <div class="content-sections">
                  ...
                  }"  v-for="(lesson,index) in section.courseLessons" :key="index" @click="playLesson(lesson)">
                  <!-- 第一章，前两节 -->
                   <div v-if="index<2">
              ...
              <div v-for="section in course.courseSections.slice(1,course.courseSections.length)">                
                ...
                <div class="content-sections">
                  <!-- 未播放的视频 -->
                  <div class="content-section" v-for="(lesson,index) in section.courseLessons" :key="index" @click="playLesson(lesson)">
                    <div>
                      <div class="section-item clearfix">
                        <span class="kw-icon-video section-type-icon fl"
                          ><i class="el-icon-video-play"></i
